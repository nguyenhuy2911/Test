...
using PingYourPackage.Domain.Entities.Enum;
using System;
...
namespace PingYourPackage.Domain.Entities.Extentions
{
    public static class ShipmentRepositoryExtensions
    {
        ...
        public static IQueryable<Shipment> GetShipmentsByAffiliateKey(this IEntityRepository<Shipment> shipmentRepository, Guid affiliateKey)
        {
        ...
        public static IQueryable<Shipment> GetNotDeliveredShipments(this IEntityRepository<Shipment> shipmentRepository, Guid affiliateKey)
        {
