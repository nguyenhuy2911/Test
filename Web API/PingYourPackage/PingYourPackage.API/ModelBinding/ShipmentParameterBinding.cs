...
namespace PingYourPackage.API.ModelBinding
{
    ...
    public class ShipmentParameterBinding : HttpParameterBinding
    {
        ...
        public ShipmentParameterBinding(HttpParameterDescriptor descriptor) : base(descriptor)
        {
        ...
        public override Task ExecuteBindingAsync(ModelMetadataProvider metadataProvider, HttpActionContext actionContext, CancellationToken cancellationToken)
        {
            ...
            var shipment = actionContext.Request.Properties[ShipmentDictionaryKey] as Shipment;
