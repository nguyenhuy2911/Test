...
namespace PingYourPackage.API.Client.Web.Controllers
{
    ...
    public class HomeController : Controller
    {
        ...
        public async Task<ViewResult> Index(int page = 1)
        {
            ...
            PaginatedDto<ShipmentDto> shipments = await _shipmentsClient.GetShipmentsAsync(
            ...
            ShipmentByAffiliateUpdateRequestModel requestModel)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                ShipmentDto updatedShipment = await _shipmentsClient.UpdateShipmentAsync(id, requestModel);
